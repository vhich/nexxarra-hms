...
from .views import ActivateUserView, ResendActivationLinkView, SendActivationEmailView, ListClinicsView, ListClinicAdminsView, SuperAdminClinicDetailView, RegisterClinicAdminView, RegisterClinicView
...
urlpatterns = [
    ...
    path('clinic_admins/', ListClinicAdminsView.as_view(), name='list-clinic-admins'),
